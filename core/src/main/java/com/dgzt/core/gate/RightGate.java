 ...
 * @author Dgzt
 */
public final class RightGate extends AbstractGate{
	 ...
	 */
	public RightGate(final ShaderProgram shader, final World box2DWorld, final float box2DX, final float box2DY) {
